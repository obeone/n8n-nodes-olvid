...
export function groupDescriptionUpdated(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// previousDescription.mockData
	...
	return client.stubs.groupNotificationStub.groupDescriptionUpdated({}, callback, (error?: Error) => { onEnd?.(error); });
}
