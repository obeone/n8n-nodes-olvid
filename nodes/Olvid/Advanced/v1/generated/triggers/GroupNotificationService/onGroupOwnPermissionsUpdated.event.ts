...
export function groupOwnPermissionsUpdated(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// previousPermissions.mockData
	...
	return client.stubs.groupNotificationStub.groupOwnPermissionsUpdated({}, callback, (error?: Error) => { onEnd?.(error); });
}
