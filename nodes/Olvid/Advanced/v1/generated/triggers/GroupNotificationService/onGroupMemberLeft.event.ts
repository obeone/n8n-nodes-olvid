...
export function groupMemberLeft(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// member.mockData
	...
	return client.stubs.groupNotificationStub.groupMemberLeft({}, callback, (error?: Error) => { onEnd?.(error); });
}
