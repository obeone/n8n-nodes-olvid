...
export function groupMemberJoined(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// member.mockData
	...
	return client.stubs.groupNotificationStub.groupMemberJoined({}, callback, (error?: Error) => { onEnd?.(error); });
}
