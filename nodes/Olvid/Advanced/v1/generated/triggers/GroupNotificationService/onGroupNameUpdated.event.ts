...
export function groupNameUpdated(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// previousName.mockData
	...
	return client.stubs.groupNotificationStub.groupNameUpdated({}, callback, (error?: Error) => { onEnd?.(error); });
}
