...
export function groupMemberPermissionsUpdated(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// previousPermissions.mockData
	...
	return client.stubs.groupNotificationStub.groupMemberPermissionsUpdated({}, callback, (error?: Error) => { onEnd?.(error); });
}
