...
export function callRinging(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// participantId.mockData
	...
	return client.stubs.callNotificationStub.callRinging({}, callback, (error?: Error) => { onEnd?.(error); });
}
