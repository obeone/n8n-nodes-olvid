...
export function callBusy(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// participantId.mockData
	...
	return client.stubs.callNotificationStub.callBusy({}, callback, (error?: Error) => { onEnd?.(error); });
}
