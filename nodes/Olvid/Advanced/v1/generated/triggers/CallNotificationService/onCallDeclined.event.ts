...
export function callDeclined(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// participantId.mockData
	...
	return client.stubs.callNotificationStub.callDeclined({}, callback, (error?: Error) => { onEnd?.(error); });
}
