...
export function callIncomingCall(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// participantCount.mockData
	...
	return client.stubs.callNotificationStub.callIncomingCall({}, callback, (error?: Error) => { onEnd?.(error); });
}
