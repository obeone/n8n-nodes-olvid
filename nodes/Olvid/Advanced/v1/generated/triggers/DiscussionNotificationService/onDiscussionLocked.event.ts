...
export function discussionLocked(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// discussion.mockData
	...
	return client.stubs.discussionNotificationStub.discussionLocked({}, callback, (error?: Error) => { onEnd?.(error); });
}
