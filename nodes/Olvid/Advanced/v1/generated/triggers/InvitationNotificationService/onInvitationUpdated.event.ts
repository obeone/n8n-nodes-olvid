...
export function invitationUpdated(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// previousInvitationStatus.mockData
	...
	return client.stubs.invitationNotificationStub.invitationUpdated({}, callback, (error?: Error) => { onEnd?.(error); });
}
