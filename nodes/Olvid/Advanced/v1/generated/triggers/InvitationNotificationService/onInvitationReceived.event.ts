...
export function invitationReceived(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// invitation.mockData
	...
	return client.stubs.invitationNotificationStub.invitationReceived({}, callback, (error?: Error) => { onEnd?.(error); });
}
