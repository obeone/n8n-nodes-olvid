...
export function messageReactionUpdated(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// previousReaction.mockData
	...
	return client.stubs.messageNotificationStub.messageReactionUpdated({}, callback, (error?: Error) => { onEnd?.(error); });
}
