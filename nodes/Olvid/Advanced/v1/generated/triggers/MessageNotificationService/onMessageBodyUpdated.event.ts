...
export function messageBodyUpdated(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// previousBody.mockData
	...
	return client.stubs.messageNotificationStub.messageBodyUpdated({}, callback, (error?: Error) => { onEnd?.(error); });
}
