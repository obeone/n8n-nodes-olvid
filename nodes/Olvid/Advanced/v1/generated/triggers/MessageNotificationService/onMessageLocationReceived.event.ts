...
export function messageLocationReceived(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// message.mockData
	...
	return client.stubs.messageNotificationStub.messageLocationReceived({}, callback, (error?: Error) => { onEnd?.(error); });
}
