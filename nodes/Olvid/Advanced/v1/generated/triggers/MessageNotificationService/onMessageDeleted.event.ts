...
export function messageDeleted(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// message.mockData
	...
	return client.stubs.messageNotificationStub.messageDeleted({}, callback, (error?: Error) => { onEnd?.(error); });
}
