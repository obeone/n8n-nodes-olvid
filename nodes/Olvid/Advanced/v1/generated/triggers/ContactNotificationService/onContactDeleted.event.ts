...
export function contactDeleted(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false, onEnd?: (error?: Error) => void): Function {
    if (returnMockData) {
...
// contact.mockData
	...
	return client.stubs.contactNotificationStub.contactDeleted({}, callback, (error?: Error) => { onEnd?.(error); });
}
